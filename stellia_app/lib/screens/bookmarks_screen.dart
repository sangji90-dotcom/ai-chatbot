  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF0A0A0F),
        elevation: 0,
        title: const Text('북마크', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
      ...
      body: _loading
          ...
          : _characters.isEmpty
              ? const Center(child: Text('북마크한 캐릭터가 없어요.', style: TextStyle(color: Color(0xFF6B7280))))
              : RefreshIndicator(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.bookmark_rounded, color: Color(0xFFFFD700), size: 12),
                                        const SizedBox(width: 4),
                                        const Text('북마크', style: TextStyle(color: Color(0xFFFFD700), fontSize: 12)),
                                      ],
                                    ),
                                  ],
                                ),
