  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF0A0A0F),
        elevation: 0,
        title: const Text('업적', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
      ...
      body: _loading
          ...
          : _achievements.isEmpty
              ? const Center(child: Text('아직 획득한 업적이 없어요.', style: TextStyle(color: Color(0xFF6B7280))))
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final isUnlocked = a['unlocked'] == true || a['unlocked_at'] != null;
                      return Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (isUnlocked && a['unlocked_at'] != null)
                                    Padding(
                                      padding: const EdgeInsets.only(top: 4),
                                      child: Text(
                                        a['unlocked_at'].toString().substring(0, 10),
                                        style: const TextStyle(color: Color(0xFF7C6CFF), fontSize: 11),
                                      ),
                                    ),
                                ],
                              ),
                            ...
                            if (isUnlocked)
                              const Icon(Icons.check_circle_rounded, color: Color(0xFF7C6CFF), size: 20)
                            else
                              const Icon(Icons.lock_rounded, color: Color(0xFF6B7280), size: 20),
                          ],
                        ),
                      );
                    },
