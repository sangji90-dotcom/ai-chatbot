...
class _CreateCharacterScreenState extends State<CreateCharacterScreen> {
  ...
  void _confirmExit() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('나가시겠어요?', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
        content: const Text('작성 중인 내용이 사라져요.', style: TextStyle(color: Color(0xFF6B7280))),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('계속 작성', style: TextStyle(color: Color(0xFF7C6CFF), fontWeight: FontWeight.w600)),
          ),
          TextButton(
            onPressed: () {
  ...
  Future<void> _submit() async {
    ...
    if (_age < 19) {
      setState(() => _message = '캐릭터 나이는 19세 이상만 등록할 수 있어요.');
      return;
    }
                    ...
                    if (_message.isNotEmpty)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xFFFF6B8A).withValues(alpha: 0.3)),
                        ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  // 서버는 19세 미만 캐릭터를 거부한다 (아동 성적 콘텐츠 방지)
                                ),
                              ],
                            ),
                          ),
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _visibility == 'public' ? const Color(0xFF7C6CFF).withValues(alpha: 0.12) : const Color(0xFF0F0F18),
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                padding: const EdgeInsets.all(14),
                                decoration: BoxDecoration(
                                  color: _visibility == 'private' ? const Color(0xFF7C6CFF).withValues(alpha: 0.12) : const Color(0xFF0F0F18),
                                  borderRadius: BorderRadius.circular(12),
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                padding: const EdgeInsets.all(14),
                                decoration: BoxDecoration(
                                  color: _isAdult == 0 ? const Color(0xFF7C6CFF).withValues(alpha: 0.12) : const Color(0xFF0F0F18),
                                  borderRadius: BorderRadius.circular(12),
                          ...
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Container(
                                padding: const EdgeInsets.all(14),
                                decoration: BoxDecoration(
                                  color: _isAdult == 1 ? const Color(0xFF7C6CFF).withValues(alpha: 0.12) : const Color(0xFF0F0F18),
                                  borderRadius: BorderRadius.circular(12),
